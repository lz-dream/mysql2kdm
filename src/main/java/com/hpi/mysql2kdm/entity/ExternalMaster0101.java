...
@Entity
@Data
@Table(name = "external_master0101")
public class ExternalMaster0101 implements Serializable{
  ...
  private Float dingzijijiazdxpp;
  @Lob
  @Basic(fetch = FetchType.LAZY)
  private byte[] dingzijijiazdx;
  private Float dingzijijiazdx1X;
  private Float dingzijijiazdx1Xp;
